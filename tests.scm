...
(define (size x)
  (cond ((> x 100) "big")
        ((< x 10) "small")
        (else "not big or small")))
; expect size

(size 20)
; expect "not big or small"
...
(define nums (list 2 76 2147483647))
(cons 1 nums)

; expect (1 2 76 2147483647)
...
(let ((x 5)) ((begin (define x (+ x 14)) +) 9 (begin (define y 7) (+ x y))))
; expect 35
